// This script attempts to gracefully rebuild and update ess-webapp-frontend if necessary
...
const DIST_DIR = 'dist';
const TITLE = 'ess-webapp-frontend';
 ...
 * @description Rebuild `ess-webapp-frontend` library
 */
function buildComponents() {
 ...
 * @description Clean `ess-webapp-frontend` library directory
 */
function cleanComponents() {
 ...
 * @description Redeploy `ess-webapp-frontend` library
 */
function deployComponents() {
